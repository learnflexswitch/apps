...
$hardware = snmp_get($device, 'kcprtGeneralModelName.1', '-OQv', 'KYOCERA-Private-MIB');

# SNMPv2-SMI::enterprises.1347.43.5.1.1.28.1 = STRING: "QUV9600664"
$serial   = snmp_get($device, '1.3.6.1.4.1.1347.43.5.1.1.28.1', '-OQv', 'KYOCERA-Private-MIB');

# KYOCERA-Private-MIB::kcprtFirmwareVersion.1.1 = STRING: "2H9_2F00.002.002"
$version  = snmp_get($device, 'kcprtFirmwareVersion.1.1', '-OQv', 'KYOCERA-Private-MIB');
