...
//Added by York Chen - 2017-05-15-start
//////////// Build dpi menu
$navbar['dpi'] = array('url' => '#', 'icon' => 'oicon-eye', 'title' => 'Dpi');
                  
$navbar['dpi']['entries'][] = array('url' => generate_url(array('page' => 'sw-frontend-dpi-rule-list','refresh' => 60)), 'icon' => 'oicon-clipboard-eye', 'title' => 'All Dpi Rules');
$navbar['dpi']['entries'][] = array('url' => generate_url(array('page' => 'sw-frontend-dpi-apply')), 'icon' => 'oicon-network-hub', 'title' => 'Apply Rules to Switch');
//$navbar['dpi']['entries'][] = array('url' => generate_url(array('page' => 'dpi-switchrules')), 'icon' => 'oicon-server--minus', 'title' => 'Rules in Switch');
$navbar['dpi']['entries'][] = array('url' => generate_url(array('page' => 'sw-frontend-dpi-eventlog')), 'icon' => 'oicon-box-search-result', 'title' => 'Dpi Event Log');
//Added by York Chen - 2017-05-15-end
