...
//$where = ' WHERE 1=1  ' . $cache['where']['devices_permitted'];
$where = ' WHERE 1=1  ' . generate_query_whistler_switchs();

//$cache['where']['whistler_switchs'];
//print("<br/>" . generate_query_whistler_switchs(). "<br/>");
...
$where .= generate_query_whistler_switchs();
...
// Print events
print_dpi_events($vars);

register_html_title('DPI Eventlog');
