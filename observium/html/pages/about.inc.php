...
?>
  ...
  <table style="width: 100%; background: transparent;">
    <tr>
      ...
      <td style="width: 22%; text-align: center;"><a class="btn btn-small" target="_blank" href="https://istuary.atlassian.net/"><i style="font-size: small;" class="icon-bug"></i>&nbsp;Bugtracker</a></td>
      ...
      <td style="width: 18%; text-align: center;"><a class="btn btn-small" target="_blank" href="https://twitter.com/istuary"><i style="font-size: small;" class="icon-twitter-sign"></i>&nbsp;Twitter</a></td>
      <td style="width: 20%; text-align: center;"><a class="btn btn-small" target="_blank" href="https://www.facebook.com/IstuaryGroup/"><i style="font-size: small;" class="icon-facebook-sign"></i>&nbsp;Facebook</a></td>
    </tr>
  </table>
  </div>
